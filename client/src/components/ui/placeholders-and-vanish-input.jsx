    ...
    return (
        <form
            ...
            <input
                ...
                type="text"
                className={twMerge(
                    "w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 text-center px-6 sm:px-12",
           ...
           px-6 sm:px-14 py-3 text-center w-[calc(100%-2rem)] truncate">
